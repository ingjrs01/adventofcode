...
class Intcode():
    ...
    def execute_instruction(self,ip,instruction,modes,data):
        ...
        if (instruction == 3): 
            ...
            data[data[ip + 3]] = int(r)
            ip += 2

        if (instruction == 4): 
            r = print("Mostrando el valor: " + str(op1))
            ip += 2
    ...
    def run(self,data): 
        ...
        while (ip < len(data)): 
            ...
            #print(modes)
            #print(data)
            ip = self.execute_instruction(ip,instruction,modes,data)
            if ip == -1:
                break
